        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleDonationSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:border-pink-300 focus:outline-none"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-pink-300 focus:outline-none"
          ...
          <div id="volunteer" className="bg-gray-100 rounded-2xl p-8">
            ...
            <form onSubmit={handleVolunteerSubmit} className="space-y-6">
              ...
              <button type="submit" className="bg-black hover:bg-gray-900 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 w-full">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 bg-gray-50 rounded-xl">
              <Users className="w-8 h-8 text-pink-300 mx-auto mb-4" />
            ...
            <div className="p-6 bg-gray-50 rounded-xl">
              <Mail className="w-8 h-8 text-pink-300 mx-auto mb-4" />
