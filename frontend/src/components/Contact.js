...
import { Send, MapPin, Mail, MessageCircle, Clock, Facebook, Twitter, Instagram, Linkedin } from "lucide-react";
...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email Us",
      details: ["sbchlvs@gmail.com", "General inquiries and support"],
      action: "Send Email",
      href: "mailto:sbchlvs@gmail.com"
    },
    {
      icon: MessageCircle,
      title: "Call or Text",
